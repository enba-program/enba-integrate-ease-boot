package com.enba.springdatajpa.service.impl;


import com.enba.springdatajpa.dao.EnbaUserRepository;
import com.enba.springdatajpa.entity.EnbaUser;
import com.enba.springdatajpa.service.EnbaUserService;
...
public class EnbaUserServiceImpl implements EnbaUserService {
  ...
  @Resource
  private EnbaUserRepository enbaUserDao;
  ...
  public EnbaUser queryById(Long id) {
    ...
    return this.enbaUserDao.findById(id).get();
  }
...
//    return this.enbaUserDao.queryAllByLimit(offset, limit);
  ...
  public EnbaUser insert(EnbaUser enbaUser) {
    return this.enbaUserDao.save(enbaUser);
...
//    return this.queryById(enbaUser.getId());
  ...
  public boolean deleteById(Long id) {
    this.enbaUserDao.deleteById(id);
