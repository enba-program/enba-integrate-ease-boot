package com.enba.integrate.justauth.enums;
 ...
 * @since 1.0.0
 */
public enum JustAuthPlatformInfoEnum {
    ...
    JustAuthPlatformInfoEnum(String name, String readme, String apiDoc, String since, boolean latest) {
        this.name = name;
        this.readme = readme;
        this.apiDoc = apiDoc;
        this.since = since;
    ...
    public static List<Map<String, Object>> getPlatformInfos() {
        ...
        JustAuthPlatformInfoEnum[] justAuthPlatformInfoEnums = JustAuthPlatformInfoEnum.values();
        for (JustAuthPlatformInfoEnum justAuthPlatformInfoEnum : justAuthPlatformInfoEnums) {
            map = new HashMap<>();
            map.put("name", justAuthPlatformInfoEnum.getName());
            map.put("readme", justAuthPlatformInfoEnum.getReadme());
            map.put("apiDoc", justAuthPlatformInfoEnum.getApiDoc());
            map.put("since", justAuthPlatformInfoEnum.getSince());
            map.put("enname", justAuthPlatformInfoEnum.name().toLowerCase());
            map.put("isLatest", justAuthPlatformInfoEnum.isLatest());
            list.add(map);
        }
        return list;
    }
